...
You can also check out [how to setup WireGuard](https://angristan.xyz/how-to-setup-vpn-server-wireguard-nat-ipv6/), a simple, safer, faster and more modern VPN protocol.

...
# Dialog Added by https://github.com/techroy23
...
function installOpenVPN () {
	...
	SERVER_CN="Z3R0_103.38.215.201"
	SERVER_NAME="Z3R0_103.38.215.201"
...
# Manage User
function Manage_1 () {
	dialog --clear --nocancel --title "[ Add / Remove Users ]" $BT \
        --menu "Manage user accounts" 16 51 51 \
        "Add" "New User" \
        "Remove" "Delete User" \
...
# Manage Vpn
function Vpn_2 () {
	dialog --clear --nocancel --title "[ Install / Uninstall OpenVpn ]" $BT \
        --menu "Manage user accounts" 16 51 51 \
        "Install" "Description here" \
        "UnInstall" "Description here" \
        "Back" "Return to Previous menu" 2> "${INPUT}"
		menuitem=$(<"${INPUT}")
			case $menuitem in
			Install)	Install_1;;
...
dialog --clear --nocancel --title "[ M A I N - M E N U ]" --backtitle "Secure OpenVPN server installer for Debian, Ubuntu, CentOS, Fedora and Arch Linux" \
        --menu "Welcome to OpenVPN-install! \n\\n\
		The git repository is available at: \n\
		https://github.com/angristan/openvpn-install \n\
		What do you want to do? \n\
		" 16 51 51 \
        "Manage" "Add / Remove Users" \
        "Vpn" "Install/Uninstall OpenVpn" \
		...
		menuitem=$(<"${INPUT}")
			...
			Vpn)		Vpn_2;;
			Settings)	Settings_3;;
			Quit)		clear; echo ""; echo ""; echo "OK Bye!"; echo ""; echo ""; break;;
			esac
done
